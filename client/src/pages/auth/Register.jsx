      ...
      <div className="text-center mb-10">
        ...
        <div className="mt-8 space-y-3">
          <h1 className="text-4xl font-bold text-gray-900 dark:text-white">
            Join the <span className="bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">Community</span>
          </h1>
          <p className="text-lg text-gray-600 dark:text-gray-300 max-w-md mx-auto">
            Create an account to start your personalized learning journey and connect with like-minded learners
          </p>
